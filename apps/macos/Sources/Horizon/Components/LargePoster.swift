...
/// 2:3 poster tile. Rendered as a plain View so an outer NavigationLink
/// receives taps — an inner Button would swallow them on macOS SwiftUI.
/// Hover lift + accent focus ring match the web `LargePoster`.
