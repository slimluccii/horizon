...
import { renderArgs, type RenderContext } from '../../application/render.ts'

export { SEGMENT_DURATION_SEC, SEG_PAD, segmentName } from '../../domain/segments.ts'
import { SEGMENT_DURATION_SEC, segmentName } from '../../domain/segments.ts'
