...
function fakePlan(overrides: Partial<import('../src/transcode/plan.ts').PlaybackPlan> = {}): import('../src/transcode/plan.ts').PlaybackPlan {
  return {
    method: 'transcode',
    needsToneMap: false,
...
function fakeSession(overrides: Partial<Session> & { plan?: import('../src/transcode/plan.ts').PlaybackPlan } = {}): Session {
  return {
    id: 's1',
    mediaId: 'm1',
    filePath: '/m.mkv',
